...
*)
   ...
   *)
    ...
    let ``08 An identifier pattern will match anything`` () =
        ...
        let y = "this is me learning F#" // replace with a string
    ...
    let ``09 A wildcard pattern will match anything`` () =
        let _ = 2020 // replace with an integer
        let _ = "soooo much fun" // replace with a string
        let _ = 'h' // replace with anything else!
        ()
    ...
    let ``11 Constant patterns fail if the sides don't match exactly`` () =
        ...
        (fun () ->
            let "FILL ME IN" = "I need this to fail"
            ()
